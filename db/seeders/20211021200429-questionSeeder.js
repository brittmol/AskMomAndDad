    ...
    return queryInterface.bulkInsert(options, [
      {
        ...
        content:
          "Every time I cook, my pans always burn! I am tired of buying new pans!",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642453571/askMomDad/Screen_Shot_2022-01-17_at_1.06.07_PM_zvuysy.png",
        userId: 1,
        categoryId: 5,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642453815/askMomDad/Screen_Shot_2022-01-17_at_1.10.11_PM_ayjteo.png",
        userId: 2,
        categoryId: 5,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        title:
          "I need advice for paying taxes for someone who is self-employed",
        content:
          "I am 21, self-employed, and will make $1M this year, I do not really want to pay 50% in taxes, what can I do to pay less tax? Is it worth expatriating and moving to a low tax country?",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642454038/askMomDad/Screen_Shot_2022-01-17_at_1.13.55_PM_mhdshk.png",
        userId: 3,
        categoryId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642454157/askMomDad/Screen_Shot_2022-01-17_at_1.15.53_PM_i7sgpd.png",
        userId: 4,
        categoryId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        content:
          "A co-worker is complaining that my clothes are highly perfumed from my laundry detergent. Can the company force me to use a different laundry detergent?",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642454306/askMomDad/Screen_Shot_2022-01-17_at_1.18.20_PM_w37dsg.png",
        userId: 5,
        categoryId: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        content:
          "I am 25 years old and I want to start a laundry business. How hard would this be? I have some money saved up to start this business",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642454396/askMomDad/Screen_Shot_2022-01-17_at_1.19.51_PM_r9pdue.png",
        userId: 6,
        categoryId: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        content:
          'My landlord is changing my lease mid-term & increased the amount, forcing me to sign a new agreement & they will "backdate the amount" if I do not?',
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642454729/askMomDad/Screen_Shot_2022-01-17_at_1.25.24_PM_gvlnr2.png",
        userId: 7,
        categoryId: 3,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        title:
          "My landlord will not give me my rent receipt, what should I do?",
        content:
          "My landlord refuses to give me a rent receipt when I pay my rent. Can I use my video recordings as proof that I paid my rent?",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642454695/askMomDad/Screen_Shot_2022-01-17_at_1.24.50_PM_ph2wlx.png",
        userId: 1,
        categoryId: 3,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        content:
          "So I know there are lot of these threads but I want to ask you again what are your favorite movies. Mine is probably Fight Club.",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642455076/askMomDad/Screen_Shot_2022-01-17_at_1.31.01_PM_rxnwj4.png",
        userId: 3,
        categoryId: 10,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642455147/askMomDad/Screen_Shot_2022-01-17_at_1.32.21_PM_vqmkgc.png",
        userId: 4,
        categoryId: 10,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642455219/askMomDad/Screen_Shot_2022-01-17_at_1.33.34_PM_zfjiz2.png",
        userId: 5,
        categoryId: 8,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642455401/askMomDad/Screen_Shot_2022-01-17_at_1.36.36_PM_fmpdqu.png",
        userId: 6,
        categoryId: 7,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        title:
          "I have been taking the same prescription medicine for years. Even though I am careful to take the same amount as always, the medicine is not working like it did in the past. What is happening?",
        content: "Should I contact my doctor about this?",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642455750/askMomDad/Screen_Shot_2022-01-17_at_1.42.25_PM_xzoy2h.png",
        userId: 2,
        categoryId: 4,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642455913/askMomDad/Screen_Shot_2022-01-17_at_1.44.51_PM_kl993f.png",
        userId: 3,
        categoryId: 6,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        content:
          "I am scared that if I take out the nail, my tire will be ruined",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642456105/askMomDad/Screen_Shot_2022-01-17_at_1.48.20_PM_rikuj4.png",
        userId: 4,
        categoryId: 7,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        content:
          "I have been dating my girlfriend for 3 years now and I do feel a sort of pressure to propose since all of her friends are getting married.",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642456225/askMomDad/Screen_Shot_2022-01-17_at_1.50.20_PM_dypjs9.png",
        userId: 5,
        categoryId: 9,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        content:
          "It has been really hard to meet people after college. Most people at my work have children and are way too busy to hang out.",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642456383/askMomDad/Screen_Shot_2022-01-17_at_1.52.56_PM_kxmmkc.png",
        userId: 6,
        categoryId: 8,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        content:
          "I want to take motrin but I think I should take tylenol instead?",
        imageURL:
          "https://res.cloudinary.com/mabmab/image/upload/v1642456611/askMomDad/Screen_Shot_2022-01-17_at_1.56.44_PM_rbf1zb.png",
        userId: 7,
        categoryId: 4,
        createdAt: new Date(),
        updatedAt: new Date(),
